...
use net_updater_api::api::getters::get_networks::get_networks_request::GetNetworksRequestDTO;
...
async fn networks_with_packets(
   ...
   //Auth stuff
    ...
    let get_networks_request = GetNetworksRequestDTO::default();
