...
async fn main() -> std::io::Result<()> { 
    ...
    HttpServer::new(move || App::new()
            ...
            .service(net_gateway::endpoints::networks::delete::network::network)
            .service(net_gateway::endpoints::networks::get::networks::networks)
            ...
            .service(net_gateway::endpoints::buffer::get::get_buffer)
        )
